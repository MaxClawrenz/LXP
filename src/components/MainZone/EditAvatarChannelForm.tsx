...
const EditAvatarChannelForm = forwardRef((props:IEditAvatarChannelForm, ref:any) => {
    ...
    return (
        <div className={style_channels.blockDialogForEditCover} ref={ref}>
            <div className={style_channels.title_and_close}>
                <div className={style_channels.title_edit_cover}>Редактировать аватар канала</div>
                <div className={style_channels.btn_close_dialogEditCover} onClick={() => {props.setChannelAvatarDialog(false)}}>
