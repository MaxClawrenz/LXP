...
//     const blockBtnsRef = useRef<HTMLDivElement>(null);

//   useEffect(() => {
//     const handleClickOutside = (event: MouseEvent) => {
//       // Check if the clicked element is outside the blockBtnsForSelect
//       if (blockBtnsRef.current && !blockBtnsRef.current.contains(event.target as Node)) {
