           ...
           <div className={style_channels.blockForTopButtons}>
                <div className={style_channels.avatarChannelButton}>
                    <div className={style_channels.hoverBlockImg}>
                        ...
                        <img alt='' className={style_channels.imgChannel} src="https://via.placeholder.com/150/771796" id="" />
                    </div>
                </div>
                ...
                <div className={style_channels.titleChannel}>PRO Дизайн</div>
                ...
                <div className={style_channels.authorChannel}>Авторы канала:  
                    <span className={style_channels.nameAuthor}><a className={style_channels.linkAuthor} href='#' target='_blank'> Щербакова Анастасия</a></span>
                </div>
                <div className={style_channels.tabsForCommentsOrArticles}>
                    <div className={style_channels.nameTab} id={style_channels.articlesChannel}>Статьи</div>
                    <div className={style_channels.nameTab_active} id={style_channels.commentsChannel}>Комментарии</div>
                </div>
       </div>
